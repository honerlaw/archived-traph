...
public class client extends Applet_Sub1
{
    ...
    public void method21(boolean flag, int i, byte abyte0[])
    {
    ...
    public void method23(boolean flag)
    {
        Class46.aClass12_785.method224();
    ...
    public void method26(boolean flag, int i)
    {
    ...
    public void method31(Class30_Sub2_Sub2 class30_sub2_sub2, int i, int j)
    {
        anInt839 = 0;
        anInt893 = 0;
        if(j <= 0)
    ...
    public void method33(boolean flag, int i)
    {
    ...
    public void method35(boolean flag, long l)
    {
        try
        {
            if(l == 0L)
    ...
    public void method39(byte byte0)
    {
    ...
    public void method41(byte byte0, long l)
    {
        try
        {
            if(l == 0L)
    ...
    public int method42(int i, int j, boolean flag, int k)
    {
        aBoolean1157 &= flag;
        int l = k >> 7;
        int i1 = j >> 7;
    ...
    public static String method43(int i, int j)
    {
        if(i != -33245)
            anInt846 = -65;
        if(j < 0x186a0)
    ...
    public void method46(int i, Class30_Sub2_Sub2 class30_sub2_sub2, byte byte0)
    {
        if(byte0 != 2)
        {
            for(int j = 1; j > 0; j++);
    ...
    public void method47(int i, boolean flag)
    {
    ...
    public boolean method48(int i, Class9 class9)
    {
        if(i <= 0)
            anInt1008 = -1;
    ...
    public void method49(int i, byte byte0, Class30_Sub2_Sub2 class30_sub2_sub2)
    {
        if(byte0 == 2)
            byte0 = 0;
        else
    ...
    public static void method52(boolean flag)
    {
    ...
    public int method54(byte byte0)
    {
    ...
    public void method65(int i, int j, int k, int l, Class9 class9, int i1, boolean flag,
            int j1, int k1)
    {
        if(aBoolean972)
            anInt992 = 32;
    ...
    public void method69(int i, boolean flag)
    {
        if(i < 0)
            return;
        if(anInt1225 != 0)
    ...
    public void method75(int i, Class9 class9)
    {
        int j = class9.anInt214;
        if(i <= 0)
    ...
    public void method77(String s, int i, String s1, boolean flag)
    {
        if(flag)
            return;
        if(i == 0 && anInt1042 != -1)
    ...
    public int method83(boolean flag, int i, int j, int k)
    {
        if(!flag)
            aClass19ArrayArrayArray827 = null;
        int l = 256 - k;
    ...
    public void method86(int i, Class30_Sub2_Sub2 class30_sub2_sub2, boolean flag)
    {
        for(int j = 0; j < anInt893; j++)
        {
            int k = anIntArray894[j];
    ...
    public void method88(int i, int j, Class30_Sub2_Sub4_Sub1_Sub2 class30_sub2_sub4_sub1_sub2, boolean flag, int k)
    {
    ...
    public void method89(boolean flag, Class30_Sub1 class30_sub1)
    {
        int i = 0;
        int j = -1;
        int k = 0;
    ...
    public void method90(boolean flag)
    {
        if(flag)
            anInt1008 = -1;
    ...
    public void method91(Class30_Sub2_Sub2 class30_sub2_sub2, int i, byte byte0)
    {
        if(byte0 == 8)
            byte0 = 0;
        else
    ...
    public void method92(boolean flag)
    {
        aBoolean1157 &= flag;
        if(anInt1021 != 0)
            return;
    ...
    public void method96(int i, int j, Class30_Sub2_Sub4_Sub1 class30_sub2_sub4_sub1)
    {
        if(i != 46988)
            anInt1008 = -1;
    ...
    public void method97(Class30_Sub2_Sub4_Sub1 class30_sub2_sub4_sub1, boolean flag)
    {
    ...
    public void method98(Class30_Sub2_Sub4_Sub1 class30_sub2_sub4_sub1, byte byte0)
    {
    ...
    public void method99(byte byte0, Class30_Sub2_Sub4_Sub1 class30_sub2_sub4_sub1)
    {
    ...
    public void method100(Class30_Sub2_Sub4_Sub1 class30_sub2_sub4_sub1, int i)
    {
        if(i >= 0)
            return;
    ...
    public void method101(Class30_Sub2_Sub4_Sub1 class30_sub2_sub4_sub1, int i)
    {
        if(i >= 0)
            aBoolean919 = !aBoolean919;
    ...
    public boolean method103(Class9 class9, boolean flag)
    {
    ...
    public void method105(int i, int j, int k, Class9 class9, int l)
    {
        if(i != 8)
            aBoolean991 = !aBoolean991;
    ...
    public void method107(int i, int j, Class30_Sub2_Sub2 class30_sub2_sub2, byte byte0, Class30_Sub2_Sub4_Sub1_Sub2 class30_sub2_sub4_sub1_sub2)
    {
        if(byte0 != 25)
            aClass19ArrayArrayArray827 = null;
        if((i & 0x400) != 0)
    ...
    public static String method110(int i, int j, boolean flag)
    {
        if(!flag)
            throw new NullPointerException();
        int k = i - j;
    ...
    public void method114(byte byte0)
    {
        if(byte0 != aByte973)
            return;
        for(int i = -1; i < anInt891; i++)
    ...
    public void method117(Class30_Sub2_Sub2 class30_sub2_sub2, int i, byte byte0)
    {
    ...
    public void method123(byte byte0, boolean flag, int i)
    {
        if(byte0 == 0)
            byte0 = 0;
        else
    ...
    public int method124(int i, Class9 class9, int j)
    {
        i = 91 / i;
    ...
    public void method128(int i, int j, int k, int l)
    {
    ...
    public void method130(int i, int j, int k, int l, int i1, int j1, int k1,
    ...
    public boolean method131(Class9 class9, boolean flag)
    {
        if(flag)
            anInt883 = -211;
    ...
    public void method136(byte byte0)
    {
        aBoolean962 = true;
        if(byte0 != 59)
            anInt1058 = -186;
    ...
    public void method137(int i, Class30_Sub2_Sub2 class30_sub2_sub2, int j)
    {
        while(i >= 0)
            j = -1;
        if(j == 84)
    ...
    public static void method138(byte byte0)
    {
    ...
    public void method139(Class30_Sub2_Sub2 class30_sub2_sub2, int i, int j)
    {
        if(i >= 0)
            anInt1118 = -7;
        class30_sub2_sub2.method418(anInt1118);
    ...
    public void method140(boolean flag)
    {
        if(!flag)
            aClass19ArrayArrayArray827 = null;
        if(anInt833 == 0)
    ...
    public void method141(Class30_Sub2_Sub1_Sub1 class30_sub2_sub1_sub1, int i, int j, boolean flag)
    {
        int k = anInt1185 + anInt1209 & 0x7ff;
        int l = i * i + j * j;
        if(flag)
    ...
    public void method143(int i, Class30_Sub2_Sub2 class30_sub2_sub2, int j)
    {
        anInt839 = 0;
        if(j != 9759)
            anInt1008 = class30_sub2_sub2.method408();
    ...
    public void method144(int i, int j, int k, int l, int i1, int j1, int k1)
    {
        int l1 = 2048 - k & 0x7ff;
    ...
    public boolean method145(boolean flag)
    {
        if(!flag)
            aClass19ArrayArrayArray827 = null;
        if(aClass24_1168 == null)
    ...
    public Class19 aClass19ArrayArrayArray827[][][];
    ...
    public Class30_Sub2_Sub2 aClass30_Sub2_Sub2_847;
    ...
    public int anInt855;
    public static BigInteger aBigInteger856 = new BigInteger("");
    public int anInt857;
    public int anInt858;
    public int anInt859;
    public int anInt860;
    ...
    public int anInt874;
    public int anInt875;
    public boolean aBooleanArray876[];
    public int anInt877;
    public int anInt878;
    public Class48 aClass48_879;
    public volatile boolean aBoolean880;
    ...
    public int anInt888;
    public int anInt889;
    public Class30_Sub2_Sub4_Sub1_Sub2 aClass30_Sub2_Sub4_Sub1_Sub2Array890[];
    public int anInt891;
    public int anIntArray892[];
    public int anInt893;
    public int anIntArray894[];
    public Class30_Sub2_Sub2 aClass30_Sub2_Sub2Array895[];
    public int anInt896;
    public int anInt897;
    public int anInt898;
    public int anInt899;
    ...
    public Class30_Sub2_Sub1_Sub1 aClass30_Sub2_Sub1_Sub1Array987[];
    public int anInt988;
    public int anInt989;
    ...
    public Class30_Sub2_Sub1_Sub1 aClass30_Sub2_Sub1_Sub1Array1033[];
    ...
    public String aStringArray1082[];
    public Class30_Sub2_Sub2 aClass30_Sub2_Sub2_1083;
    ...
    public Class30_Sub2_Sub1_Sub1 aClass30_Sub2_Sub1_Sub1Array1095[];
    ...
    public int anIntArrayArrayArray1129[][][];
    ...
    public static String aString1162 = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"\243$%^&*()-_=+[{]};:'@#~,<.>/?\\| ";
    ...
    public Class30_Sub2_Sub2 aClass30_Sub2_Sub2_1192;
