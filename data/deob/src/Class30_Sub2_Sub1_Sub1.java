...
public class Class30_Sub2_Sub1_Sub1 extends Class30_Sub2_Sub1
{
    ...
    public void method347(int i, int j, int k, int l, int i1, int j1, int k1, 
            int ai[], int ai1[])
    {
        int l1 = -(j >> 2);
        j = -(j & 3);
    ...
    public void method351(int i, int j, int ai[], int k, int ai1[], int l, int i1, 
    ...
    public void method355(int ai[], int i, byte abyte0[], int j, int ai1[], int k, boolean flag, 
