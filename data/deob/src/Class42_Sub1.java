    ...
    implements Runnable
{
    ...
    public void method554(boolean flag, int i)
    {
    ...
    public int method559(int i, int j)
    {
        if(j >= 0)
            anInt1345 = -7;
    ...
    public void method563(byte byte0, int i, int j, byte byte1)
    {
        if(byte1 == 8)
            byte1 = 0;
        else
    ...
    public boolean method569(int i, int j)
    {
        if(j != 5)
            anInt1345 = 169;
